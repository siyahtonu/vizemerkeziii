  ...
  <div className="min-h-screen bg-slate-50">
    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed">
        <section>
          <h2 className="text-xl font-black text-slate-900">Topladığımız Veriler</h2>
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">Çerezler</h2>
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">Veri Paylaşımı</h2>
