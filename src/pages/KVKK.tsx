...
const KVKK: React.FC = () => (
  <div className="min-h-screen bg-slate-50">
    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 prose prose-slate max-w-none">
      <h1 className="text-3xl font-black text-slate-900 mb-2">KVKK Aydınlatma Metni</h1>
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">2. İşlenen Kişisel Veriler</h2>
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">3. Kişisel Verilerin İşlenme Amaçları</h2>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">4. Hukuki Dayanak</h2>
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">5. Veri Saklama Süresi</h2>
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">6. İlgili Kişi Hakları (KVKK Madde 11)</h2>
        ...
        <section>
          <h2 className="text-xl font-black text-slate-900">7. İletişim</h2>
